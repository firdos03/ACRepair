        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <button className="bg-blue-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-blue-700 transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-200">
                Book a Technician <ChevronRight size={20} />
              </button>
              <button className="bg-white text-slate-700 border border-slate-200 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-slate-50 transition-all shadow-sm">
                View Pricing
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-slate-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">10+ Years Experience</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
          ...
          >
            <div className="relative rounded-[40px] overflow-hidden shadow-2xl border-8 border-white">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1584270538949-6fb56572cddd?q=80&w=1080"
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-3xl shadow-xl max-w-[240px] hidden md:block border border-slate-50">
              <div className="flex items-center gap-4 mb-3">
                ...
                <div className="text-sm font-bold text-slate-900">5k+ Served</div>
              </div>
